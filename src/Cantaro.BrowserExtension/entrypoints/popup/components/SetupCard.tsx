...
export function SetupCard({ onOpenSettings, onSignIn, isSigningIn }: SetupCardProps) {
  return (
    <GlassCard className="mx-auto max-w-4xl p-5">
      <p className="text-xs font-semibold text-violet-700">Cantaro extension</p>
      <h2 className="mt-1 text-xl font-bold text-gray-900">Connect to your Cantaro instance</h2>
