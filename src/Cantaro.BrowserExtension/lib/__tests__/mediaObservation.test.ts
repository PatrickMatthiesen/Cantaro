...
function makeObservation(overrides: Partial<MediaObservation> = {}): MediaObservation {
  return {
    ...
    nextEpisodeProviderId: 'NEXT2',
    nextEpisodeUrl: 'https://www.crunchyroll.com/watch/NEXT2/episode-2',
    nextEpisodeTitle: 'Episode 2 - The Journey',
    nextEpisodeNumber: 2,
...
describe('toSubmitMediaObservationRequest', () => {
  it('maps extension observations to the backend DTO contract', () => {
    ...
    expect(request).toEqual({
      ...
      seasonNumber: 2,
      providerSeriesId: 'SERIES1',
      providerSeasonId: undefined,
      providerSequenceNumber: undefined,
      nextEpisodeProviderId: 'NEXT2',
      nextEpisodeUrl: 'https://www.crunchyroll.com/watch/NEXT2/episode-2',
      nextEpisodeTitle: 'Episode 2 - The Journey',
      nextEpisodeNumber: 2,
      observedEpisodes: undefined,
      progressHint: '1',
      watchProgressPercent: 85.5,
      durationSeconds: 1440,
      positionSeconds: 1231.2,
