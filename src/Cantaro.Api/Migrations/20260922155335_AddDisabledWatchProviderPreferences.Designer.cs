...
namespace Cantaro.Api.Migrations
{
    ...
    [Migration("20260922155335_AddDisabledWatchProviderPreferences")]
    partial class AddDisabledWatchProviderPreferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cantaro.Api.Models.UserSettings", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("DisabledWatchProviders")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValue(new string[0]);
