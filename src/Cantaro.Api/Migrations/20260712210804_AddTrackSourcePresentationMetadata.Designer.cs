...
namespace Cantaro.Api.Migrations
{
    ...
    [Migration("20260712210804_AddTrackSourcePresentationMetadata")]
    partial class AddTrackSourcePresentationMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cantaro.Api.Models.TrackSourceId", b =>
                {
                    ...
                    b.Property<string>("PresentationKind")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<DateTimeOffset?>("PresentationKindClassifiedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal?>("PresentationKindConfidence")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)");

                    b.Property<string>("PresentationKindEvidenceIdentity")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("PresentationKindEvidenceMethod")
                        .HasMaxLength(96)
                        .HasColumnType("character varying(96)");

                    b.Property<string>("PresentationKindEvidenceSource")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("PresentationKindMethodVersion")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<Guid?>("PresentationKindRevision")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("UploaderAuthority")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");

                    b.Property<DateTimeOffset?>("UploaderAuthorityClassifiedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal?>("UploaderAuthorityConfidence")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)");

                    b.Property<string>("UploaderAuthorityEvidenceIdentity")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("UploaderAuthorityEvidenceMethod")
                        .HasMaxLength(96)
                        .HasColumnType("character varying(96)");

                    b.Property<string>("UploaderAuthorityEvidenceSource")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("UploaderAuthorityMethodVersion")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<Guid?>("UploaderAuthorityRevision")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cantaro.Api.Models.TrackVersionTrait", b =>
                {
                    ...
                    b.Property<string>("EvidenceMethod")
                        .IsRequired()
                        .HasMaxLength(96)
                        .HasColumnType("character varying(96)");
                    ...
                    b.Property<string>("RevokedByType")
                        .HasMaxLength(24)
                        .HasColumnType("character varying(24)");

                    b.Property<Guid?>("SupersedesTraitId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SupersedesTraitId");

                    b.HasIndex("TrackId", "RevokedAt", "TraitKey")
                        .HasDatabaseName("IX_TrackVersionTraits_Track_Active_Trait");

                    b.HasIndex("TrackId", "TraitKey", "EvidenceSource", "EvidenceIdentity", "EvidenceMethod")
                        .IsUnique()
                        .HasDatabaseName("UX_TrackVersionTraits_ActiveEvidence")
                        .HasFilter("\"RevokedAt\" IS NULL");

                    b.ToTable("TrackVersionTraits", t =>
                        {
                            t.HasCheckConstraint("CK_TrackVersionTraits_Confidence", "CAST(\"Confidence\" AS REAL) >= 0 AND CAST(\"Confidence\" AS REAL) <= 1");

                            t.HasCheckConstraint("CK_TrackVersionTraits_Revocation", "\"RevokedAt\" IS NULL OR \"RevokedAt\" >= \"CreatedAt\"");

                            t.HasCheckConstraint("CK_TrackVersionTraits_RevocationAudit", "(\"RevokedAt\" IS NULL AND \"RevokedByType\" IS NULL AND \"RevokedById\" IS NULL AND \"RevocationReason\" IS NULL) OR (\"RevokedAt\" IS NOT NULL AND \"RevokedByType\" IS NOT NULL AND \"RevokedById\" IS NOT NULL AND \"RevocationReason\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Cantaro.Api.Models.TrackVersionTrait", b =>
                {
                    b.HasOne("Cantaro.Api.Models.TrackVersionTrait", "SupersedesTrait")
                        .WithMany()
                        .HasForeignKey("SupersedesTraitId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Cantaro.Api.Models.Track", "Track")
                        .WithMany("VersionTraits")
                        .HasForeignKey("TrackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SupersedesTrait");
